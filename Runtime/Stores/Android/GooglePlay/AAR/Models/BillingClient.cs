...
namespace UnityEngine.Purchasing.Stores.Android.GooglePlay.AAR.Models
{
    /// <summary>
    ...
    sealed class BillingClient : BillingClientBase, IBillingClient
    {
        ...
        [Preserve]
        internal BillingClient(IGooglePurchasesUpdatedListener googlePurchasesUpdatedListener, IUtil util,
            ITelemetryDiagnostics telemetryDiagnostics) : base(util, telemetryDiagnostics)
        {
        ...
        public void ConsumeAsync(string purchaseToken, Action<IGoogleBillingResult> onConsume)
        {
            ...
            m_BillingClient.Call("consumeAsync", consumeParams, new GoogleConsumeResponseListener(onConsume, m_Util));
        }
        ...
        public void AcknowledgePurchase(string purchaseToken, Action<IGoogleBillingResult> onAcknowledge)
        {
            ...
            m_BillingClient.Call("acknowledgePurchase", acknowledgePurchaseParams, new GoogleAcknowledgePurchaseListener(onAcknowledge, m_Util));
        }
