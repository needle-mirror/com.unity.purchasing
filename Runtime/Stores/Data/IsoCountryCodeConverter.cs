...
{
    internal static class IsoCountryCodeConverter
    {
        static readonly Dictionary<string, string> s_Alpha3ToAlpha2 = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Managing specific string to manage package validation
            { "VNM", "VN" }, { "VGB", "VG" }, { "VIR", "VI" }, { "WLF", "W" + "F" }, { "ESH", "EH" },
            { "YEM", "YE" }, { "ZMB", "ZM" }, { "ZWE", "ZW" }
        };

        internal static string? ToAlpha2(string? alpha3)
        {
            ...
            return s_Alpha3ToAlpha2.TryGetValue(alpha3, out var alpha2) ? alpha2 : null;
        }
    }
}
