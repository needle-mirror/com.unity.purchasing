...
namespace UnityEngine.Purchasing.PaymentProviderService.MockCheckout
{
    ...
    /// <summary>
    /// MockCheckoutApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class MockCheckoutApiBaseRequest
    {
        /// <summary>
    ...
    /// <summary>
    /// CancelMockCheckoutOrderRequest
    /// Cancel mock checkout order
    /// </summary>
    [Preserve]
    internal class CancelMockCheckoutOrderRequest : MockCheckoutApiBaseRequest
    {
        ...
        /// <summary>
        /// CancelMockCheckoutOrder Request Object.
        /// Cancel mock checkout order
        /// </summary>
        ...
        [Preserve]
        public CancelMockCheckoutOrderRequest(string projectId, string environmentId, string orderId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/mock-checkout/orders/{orderId}/cancel";
    ...
    /// <summary>
    /// ConfirmMockCheckoutOrderRequest
    /// Confirm mock checkout order
    /// </summary>
    [Preserve]
    internal class ConfirmMockCheckoutOrderRequest : MockCheckoutApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// ConfirmMockCheckoutOrder Request Object.
        /// Confirm mock checkout order
        /// </summary>
        /// <param name="projectId">ID of the Unity project.</param>
        /// <param name="environmentId">ID of the Unity environment.</param>
        /// <param name="orderId">ID of the Unity order.</param>
        [Preserve]
        public ConfirmMockCheckoutOrderRequest(string projectId, string environmentId, string orderId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/mock-checkout/orders/{orderId}/confirm";
    ...
    /// <summary>
    /// GetMockCheckoutAssetRequest
    /// Mock checkout UI assets
    /// </summary>
    [Preserve]
    internal class GetMockCheckoutAssetRequest : MockCheckoutApiBaseRequest
    {
        string PathAndQueryParams;

        /// <summary>
        /// GetMockCheckoutAsset Request Object.
        /// Mock checkout UI assets
        /// </summary>
        [Preserve]
        public GetMockCheckoutAssetRequest()
        {
            PathAndQueryParams = $"/mock-checkout/(.*)";
    ...
    /// <summary>
    /// GetMockCheckoutOrderRequest
    /// Get mock checkout order
    /// </summary>
    [Preserve]
    internal class GetMockCheckoutOrderRequest : MockCheckoutApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// GetMockCheckoutOrder Request Object.
        /// Get mock checkout order
        /// </summary>
        /// <param name="projectId">ID of the Unity project.</param>
        /// <param name="environmentId">ID of the Unity environment.</param>
        /// <param name="orderId">ID of the Unity order.</param>
        [Preserve]
        public GetMockCheckoutOrderRequest(string projectId, string environmentId, string orderId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/mock-checkout/orders/{orderId}";
