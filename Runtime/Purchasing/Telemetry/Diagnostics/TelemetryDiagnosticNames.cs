namespace UnityEngine.Purchasing.Telemetry
{
    static class TelemetryDiagnosticNames
    {
        ...
        internal const string QueryAsyncProductError = "query_async_sku_error";
        internal const string SkuDetailsResponseConsolidatorError = "sku_details_response_consolidator_error";
        internal const string SkuDetailsResponseError = "sku_details_response_error";
    }
}
