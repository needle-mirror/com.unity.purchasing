...
namespace UnityEngine.Purchasing.TransactionVerifier.Google
{
    ...
    /// <summary>
    /// GoogleApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class GoogleApiBaseRequest
    {
        /// <summary>
    ...
    /// <summary>
    /// FulfillGoogleTransactionRequest
    /// Mark a Google Play Store order/transaction as fulfilled
    /// </summary>
    [Preserve]
    internal class FulfillGoogleTransactionRequest : GoogleApiBaseRequest
    {
        ...
        /// <summary>
        /// FulfillGoogleTransaction Request Object.
        /// Mark a Google Play Store order/transaction as fulfilled
        /// </summary>
        /// <param name="projectId">ID of the Unity project.</param>
        /// <param name="environmentId">ID of the Unity environment.</param>
        /// <param name="orderId">ID of the order/transaction/receipt from a Google Play Store receipt.</param>
        [Preserve]
        public FulfillGoogleTransactionRequest(string projectId, string environmentId, string orderId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/transactions/google/{orderId}/fulfilled";
    ...
    /// <summary>
    /// VerifyGoogleTransactionRequest
    /// Verify Google Play Store transaction
    /// </summary>
    [Preserve]
    internal class VerifyGoogleTransactionRequest : GoogleApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        [Preserve]
        public string EnvironmentId { get; }
        /// <summary>Accessor for verifyGoogleTransactionRequestParameter </summary>
        [Preserve]
        public UnityEngine.Purchasing.TransactionVerifier.Models.VerifyGoogleTransactionRequest VerifyGoogleTransactionRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// VerifyGoogleTransaction Request Object.
        /// Verify Google Play Store transaction
        /// </summary>
        /// <param name="projectId">ID of the Unity project.</param>
        /// <param name="environmentId">ID of the Unity environment.</param>
        /// <param name="verifyGoogleTransactionRequestParameter">VerifyGoogleTransactionRequest param</param>
        [Preserve]
        public VerifyGoogleTransactionRequest(string projectId, string environmentId, UnityEngine.Purchasing.TransactionVerifier.Models.VerifyGoogleTransactionRequest verifyGoogleTransactionRequestParameter)
        {
            ProjectId = projectId;

            EnvironmentId = environmentId;

            VerifyGoogleTransactionRequestParameter = verifyGoogleTransactionRequestParameter;
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/transactions/google";
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(VerifyGoogleTransactionRequestParameter);
        }
