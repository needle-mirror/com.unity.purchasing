...
{
    /// <summary>
    /// Object representing a Google Play Store transaction
    /// </summary>
    [Preserve]
    [DataContract(Name = "google-transaction-dto")]
    internal class GoogleTransactionDto
    {
        /// <summary>
        /// Object representing a Google Play Store transaction
        /// </summary>
        ...
        /// <param name="purchaseState">purchaseState param</param>
        [Preserve]
        public GoogleTransactionDto(string hash = default, string playerId = default, string projectId = default, bool fulfilled = default, DateTime? fulfilledAt = default, string orderId = default, string productId = default, int? quantity = default, string transactionType = default, DateTime validatedAt = default, DateTime updatedAt = default, GooglePurchaseState purchaseState = default)
        {
            Hash = hash;
            PlayerId = playerId;
            ProjectId = projectId;
        ...
        internal string SerializeAsPathParam()
        {
            ...
            if (OrderId != null)
            {
                serializedModel += "order_id," + OrderId + ",";
            }
            if (ProductId != null)
            {
            ...
            serializedModel += "purchase_state," + PurchaseState.ToString();
            return serializedModel;
        }

        /// <summary>
        /// Returns a GoogleTransactionDto as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
