...
namespace Samples.Purchasing.GooglePlay.UpgradeDowngradeSubscription
{
    ...
    public class UpgradeDowngradeSubscription : MonoBehaviour, IDetailedStoreListener
    {
        ...
        public GooglePlayReplacementMode upgradeSubscriptionReplacementMode = GooglePlayReplacementMode.ImmediateAndChargeProratedPrice;
        public GooglePlayReplacementMode downgradeSubscriptionReplacementMode = GooglePlayReplacementMode.Deferred;
        ...
        public void OnInitialized(IStoreController controller, IExtensionProvider extensions)
        {
            ...
            m_SubscriptionGroup = new SubscriptionGroup(controller, extensions, upgradeSubscriptionReplacementMode, downgradeSubscriptionReplacementMode,
