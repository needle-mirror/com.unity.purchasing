...
public class PaywallManager : MonoBehaviour
{
    ...
    void InitCatalog()
    {
        ...
        {
            {k_IapSubscriptionAdventurePassSkuID, GooglePlay.Name},
            {k_IapSubscriptionAdventurePassSkuID, AppleAppStore.Name}
        };
    ...
    {
        m_ProductService.AddProductsUpdatedAction(m_IAPPaywallCallbacks.OnInitialProductsFetched);
        m_ProductService.AddProductsFetchFailedAction(m_IAPPaywallCallbacks.OnInitialProductsFetchFailed);
    }

    void ConfigurePurchasingServiceCallbacks()
    {
        m_PurchasingService.AddFetchedPurchasesAction(m_IAPPaywallCallbacks.OnExistingPurchasesFetched);
        m_PurchasingService.AddFetchPurchasesFailedAction(m_IAPPaywallCallbacks.OnExistingPurchasesFetchFailed);
        m_PurchasingService.AddPendingOrderUpdatedAction(m_IAPPaywallCallbacks.OnOrderPending);
        m_PurchasingService.AddConfirmedOrderUpdatedAction(m_IAPPaywallCallbacks.OnOrderConfirmed);
        m_PurchasingService.AddPurchaseFailedAction(m_IAPPaywallCallbacks.OnPurchaseFailed);
        m_PurchasingService.AddPurchaseDeferredAction(m_IAPPaywallCallbacks.OnOrderDeferred);
    }
    ...
    public void FetchExistingPurchases()
    {
        ...
        {
            m_IAPLogger.LogPurchaseFetchException(exception);
        }
    }
    ...
    async void ConnectToStore()
    {
        ...
        {
            m_IAPLogger.LogStoreConnectionException(exception);
        }
    }
    ...
    void FetchInitialProducts()
    {
        ...
        {
            m_IAPLogger.LogProductFetchException(exception);
        }
    }
    ...
    bool IsGooglePlay()
    {
        return Application.platform == RuntimePlatform.Android && DefaultStoreHelper.GetDefaultStoreName() == GooglePlay.Name;
    }
}
