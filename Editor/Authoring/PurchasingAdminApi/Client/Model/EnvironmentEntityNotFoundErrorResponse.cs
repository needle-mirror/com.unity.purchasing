...
{
    /// <summary>
    /// EnvironmentEntityNotFoundErrorResponse
    /// </summary>
    ...
    public partial class EnvironmentEntityNotFoundErrorResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentEntityNotFoundErrorResponse" /> class.
        /// </summary>
        ...
        [Preserve]
        public EnvironmentEntityNotFoundErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for EnvironmentEntityNotFoundErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
