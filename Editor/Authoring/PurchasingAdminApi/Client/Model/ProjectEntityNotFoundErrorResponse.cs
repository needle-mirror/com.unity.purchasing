...
{
    /// <summary>
    /// ProjectEntityNotFoundErrorResponse
    /// </summary>
    [DataContract(Name = "ProjectEntityNotFoundErrorResponse")]
    [Preserve]
    internal partial class ProjectEntityNotFoundErrorResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectEntityNotFoundErrorResponse" /> class.
        /// </summary>
        ...
        [Preserve]
        public ProjectEntityNotFoundErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ProjectEntityNotFoundErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
