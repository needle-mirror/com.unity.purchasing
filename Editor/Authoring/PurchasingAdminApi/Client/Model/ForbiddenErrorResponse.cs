...
namespace UnityEditor.Purchasing.Editor.Authoring.PurchasingAdminApi
{
    ...
    /// </summary>
    [DataContract(Name = "ForbiddenErrorResponse")]
    [Preserve]
    internal partial class ForbiddenErrorResponse
    {
        /// <summary>
        ...
        [Preserve]
        public ForbiddenErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ForbiddenErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
