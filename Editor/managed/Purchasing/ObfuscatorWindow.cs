...
#else
        internal const string kOutputPath = "Assets/Plugins/UnityPurchasing/generated";
#endif
...
#if !UNITY_UNIFIED_IAP
        private const string kAppleCertPath = "Assets/Plugins/UnityPurchasing/Editor/AppleIncRootCertificate.cer";
#else
