namespace UnityEditor.Purchasing
{
    internal static class EventActions
    {
        ...
        internal const string k_ActionAddProduct = "add_product";
        internal const string k_ActionAddTranslation = "add_translation";
        internal const string k_ActionAppStoreExport = "app_store_export";
        internal const string k_ActionObfuscationGooglePlayButton = "obfuscation_google_play_button";
        internal const string k_ActionObfuscationOpenWindow = "obfuscation_open_window";
        internal const string k_ActionOpenCatalog = "open_catalog";
        internal const string k_ActionRemovePayout = "remove_payout";
